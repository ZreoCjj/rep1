	...
	<script>
        ...
        function findByPage(page ,oldPageSize) {
            ...
            if (pageSize == oldPageSize) {
                location.href = "${pageContext.servletContext.contextPath}/sysLog/findAll?page=" +
                    page + "&pageSize=" +
                    oldPageSize;
            } else {
                location.href = "${pageContext.servletContext.contextPath}/sysLog/findAll?page=1&pageSize=" + pageSize;
            }
        }
