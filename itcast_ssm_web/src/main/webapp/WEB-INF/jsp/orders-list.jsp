	...
	<script>
        ...
        function findByPage(page ,oldPageSize) {
            ...
            if (pageSize == oldPageSize) {
                location.href = "${pageContext.servletContext.contextPath}/orders/findAll?page=" +
					page + "&pageSize=" +
                    oldPageSize;
            } else {
                location.href = "${pageContext.servletContext.contextPath}/orders/findAll?page=1&pageSize=" + pageSize;
            }
        }
								...
								<div class="form-group form-inline">
									<div class="btn-group">
										...
										<button type="button" class="btn btn-default" title="刷新"
												onclick="findByPage('${pageInfo.pageNum}','${pageInfo.pageSize}');">
