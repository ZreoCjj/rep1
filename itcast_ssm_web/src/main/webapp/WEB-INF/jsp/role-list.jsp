    ...
    <script>
        ...
        function findByPage(page, oldPageSize) {
            ...
            if (pageSize == oldPageSize) {
                location.href = "${pageContext.servletContext.contextPath}/role/findAll?page=" +
                    page + "&pageSize=" +
                    oldPageSize;
            } else {
                location.href =
                    "${pageContext.servletContext.contextPath}/role/findAll?page=1&pageSize=" +
                    pageSize;
            }
                            ...
                            <div class="form-group form-inline">
                                <div class="btn-group">
                                    <button type="button" class="btn btn-default" title="新建"
                                            onclick="location.href='${pageContext.request.contextPath}/toRoleAdd'">
                            ...
                            <c:forEach items="${pageInfo.list}" var="role">
                                <tr>
                                    ...
                                    <td class="text-center">
                                        ...
                                        <a
                                                href="${pageContext.request.contextPath}/role/findRoleByIdAndAllPermission?id=${role.id}"
